...
mixin _$WalletEntity {
 ...
 int get balance; DateTime? get lastBonusDate;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WalletEntity&&(identical(other.balance, balance) || other.balance == balance)&&(identical(other.lastBonusDate, lastBonusDate) || other.lastBonusDate == lastBonusDate));
}


@override
int get hashCode => Object.hash(runtimeType,balance,lastBonusDate);

@override
String toString() {
  return 'WalletEntity(balance: $balance, lastBonusDate: $lastBonusDate)';
}
...
@useResult
$Res call({
 int balance, DateTime? lastBonusDate
});
...
/// Create a copy of WalletEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? balance = null,Object? lastBonusDate = freezed,}) {
  return _then(_self.copyWith(
balance: null == balance ? _self.balance : balance // ignore: cast_nullable_to_non_nullable
as int,lastBonusDate: freezed == lastBonusDate ? _self.lastBonusDate : lastBonusDate // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int balance,  DateTime? lastBonusDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WalletEntity() when $default != null:
return $default(_that.balance,_that.lastBonusDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int balance,  DateTime? lastBonusDate)  $default,) {final _that = this;
switch (_that) {
case _WalletEntity():
return $default(_that.balance,_that.lastBonusDate);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int balance,  DateTime? lastBonusDate)?  $default,) {final _that = this;
switch (_that) {
case _WalletEntity() when $default != null:
return $default(_that.balance,_that.lastBonusDate);case _:
  return null;
...
class _WalletEntity extends WalletEntity {
  const _WalletEntity({required this.balance, this.lastBonusDate}): assert(balance >= 0, 'Wallet balance must not be negative'),super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WalletEntity&&(identical(other.balance, balance) || other.balance == balance)&&(identical(other.lastBonusDate, lastBonusDate) || other.lastBonusDate == lastBonusDate));
}
...
/// Create a copy of WalletEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? balance = null,Object? lastBonusDate = freezed,}) {
