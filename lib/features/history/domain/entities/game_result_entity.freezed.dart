...
mixin _$GameResultEntity {
 ...
 GameStatus get result; PlayerSide get humanSide; double get aiLevel; int get betAmount; int get winnings; DateTime get playedAt; Duration get duration; int get moveCount;
...
@override
int get hashCode => Object.hash(runtimeType,result,humanSide,aiLevel,betAmount,winnings,playedAt,duration,moveCount);

@override
String toString() {
  return 'GameResultEntity(result: $result, humanSide: $humanSide, aiLevel: $aiLevel, betAmount: $betAmount, winnings: $winnings, playedAt: $playedAt, duration: $duration, moveCount: $moveCount)';
}
...
@useResult
$Res call({
 GameStatus result, PlayerSide humanSide, double aiLevel, int betAmount, int winnings, DateTime playedAt, Duration duration, int moveCount
});
...
/// Create a copy of GameResultEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? result = null,Object? humanSide = null,Object? aiLevel = null,Object? betAmount = null,Object? winnings = null,Object? playedAt = null,Object? duration = null,Object? moveCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( GameStatus result,  PlayerSide humanSide,  double aiLevel,  int betAmount,  int winnings,  DateTime playedAt,  Duration duration,  int moveCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameResultEntity() when $default != null:
return $default(_that.result,_that.humanSide,_that.aiLevel,_that.betAmount,_that.winnings,_that.playedAt,_that.duration,_that.moveCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( GameStatus result,  PlayerSide humanSide,  double aiLevel,  int betAmount,  int winnings,  DateTime playedAt,  Duration duration,  int moveCount)  $default,) {final _that = this;
switch (_that) {
case _GameResultEntity():
return $default(_that.result,_that.humanSide,_that.aiLevel,_that.betAmount,_that.winnings,_that.playedAt,_that.duration,_that.moveCount);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( GameStatus result,  PlayerSide humanSide,  double aiLevel,  int betAmount,  int winnings,  DateTime playedAt,  Duration duration,  int moveCount)?  $default,) {final _that = this;
switch (_that) {
case _GameResultEntity() when $default != null:
return $default(_that.result,_that.humanSide,_that.aiLevel,_that.betAmount,_that.winnings,_that.playedAt,_that.duration,_that.moveCount);case _:
  return null;
...
class _GameResultEntity extends GameResultEntity {
  const _GameResultEntity({required this.result, required this.humanSide, required this.aiLevel, required this.betAmount, required this.winnings, required this.playedAt, required this.duration, required this.moveCount}): super._();
...
/// Create a copy of GameResultEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? result = null,Object? humanSide = null,Object? aiLevel = null,Object? betAmount = null,Object? winnings = null,Object? playedAt = null,Object? duration = null,Object? moveCount = null,}) {
