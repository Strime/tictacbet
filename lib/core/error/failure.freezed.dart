...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppFailure&&(identical(other.debugInfo, debugInfo) || other.debugInfo == debugInfo));
}
...
@override
String toString() {
  return 'AppFailure(debugInfo: $debugInfo)';
}
...
/// Create a copy of AppFailure
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? debugInfo = freezed,}) {
...
class UnknownFailure implements AppFailure {
  const UnknownFailure({this.debugInfo});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnknownFailure&&(identical(other.debugInfo, debugInfo) || other.debugInfo == debugInfo));
}
...
@override
String toString() {
  return 'AppFailure.unknown(debugInfo: $debugInfo)';
}
